...
data class PostParameter(val description: String?, val name: String, val key: String?, val type: Short,
                val dataType: Short, val defaultValue: String?, val minValue: String?, val maxValue: String?,
                val saved: String, val order: Int?, var avatarId: Long? = null, var parameterId: Long? = null)
